...
public class CropBlock extends BlockCrops implements IGrowable, IPlantable, CropGrowable {
  ...
  public CropBlock(String registerName, String name) {
    super();
  ...
  public String getStageId(int stage) {
    if (BASE_STAGE_ID == null) {
      BASE_STAGE_ID = registerName.replaceFirst("vimcat", "") + "_stage";
    }
  ...
  public Item getSeed() {
    if (seed == null) {
      FMLLog.bigWarning("No seed has been set up for %s!", getUnlocalizedName());
      return new Item();
    }
  ...
  public boolean equals(Object obj) {
    return (obj instanceof CropBlock && registerName.equals(((CropBlock) obj).registerName));
  }

  @Override
  public List<ItemStack> getDrops(IBlockState world, BlockPos pos, IBlockState state, int fortune) {
    final List<ItemStack> list = new java.util.ArrayList<ItemStack>();
